...
public:
    ...
    void Set(const uint256& t, int b, unsigned int xap, int64_t bt)
    {
        txid = t;
        block = b;
        tx_idx = xap;
...
int ParseTransaction(const CTransaction& tx, int nBlock, unsigned int xap, CMPTransaction& mptx, unsigned int nTime=0);
