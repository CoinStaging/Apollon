 ...
 */
uint8_t create2_cell_body_get_handshake_data(create2_cell_body_t *inp, size_t xap);
/** As create2_cell_body_get_handshake_data, but take and return a
 * const pointer
 */
uint8_t create2_cell_body_getconst_handshake_data(const create2_cell_body_t *inp, size_t xap);
 ...
 * hold the value 'elt'.
 */
int create2_cell_body_set_handshake_data(create2_cell_body_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t ed25519_cert_extension_get_un_signing_key(ed25519_cert_extension_t *inp, size_t xap);
/** As ed25519_cert_extension_get_un_signing_key, but take and return
 * a const pointer
 */
uint8_t ed25519_cert_extension_getconst_un_signing_key(const ed25519_cert_extension_t *inp, size_t xap);
 ...
 */
int ed25519_cert_extension_set_un_signing_key(ed25519_cert_extension_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t ed25519_cert_extension_get_un_unparsed(ed25519_cert_extension_t *inp, size_t xap);
/** As ed25519_cert_extension_get_un_unparsed, but take and return a
 * const pointer
 */
uint8_t ed25519_cert_extension_getconst_un_unparsed(const ed25519_cert_extension_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * un_unparsed of the ed25519_cert_extension_t in 'inp', so that it
 * will hold the value 'elt'.
 */
int ed25519_cert_extension_set_un_unparsed(ed25519_cert_extension_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t extend1_cell_body_get_onionskin(extend1_cell_body_t *inp, size_t xap);
/** As extend1_cell_body_get_onionskin, but take and return a const
 * pointer
 */
uint8_t extend1_cell_body_getconst_onionskin(const extend1_cell_body_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * onionskin of the extend1_cell_body_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int extend1_cell_body_set_onionskin(extend1_cell_body_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t extend1_cell_body_get_identity(extend1_cell_body_t *inp, size_t xap);
/** As extend1_cell_body_get_identity, but take and return a const
 * pointer
 */
uint8_t extend1_cell_body_getconst_identity(const extend1_cell_body_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * identity of the extend1_cell_body_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int extend1_cell_body_set_identity(extend1_cell_body_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t link_specifier_get_un_ipv6_addr(link_specifier_t *inp, size_t xap);
/** As link_specifier_get_un_ipv6_addr, but take and return a const
 * pointer
 */
uint8_t link_specifier_getconst_un_ipv6_addr(const link_specifier_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * un_ipv6_addr of the link_specifier_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int link_specifier_set_un_ipv6_addr(link_specifier_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t link_specifier_get_un_legacy_id(link_specifier_t *inp, size_t xap);
/** As link_specifier_get_un_legacy_id, but take and return a const
 * pointer
 */
uint8_t link_specifier_getconst_un_legacy_id(const link_specifier_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * un_legacy_id of the link_specifier_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int link_specifier_set_un_legacy_id(link_specifier_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t link_specifier_get_un_ed25519_id(link_specifier_t *inp, size_t xap);
/** As link_specifier_get_un_ed25519_id, but take and return a const
 * pointer
 */
uint8_t link_specifier_getconst_un_ed25519_id(const link_specifier_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * un_ed25519_id of the link_specifier_t in 'inp', so that it will
 * hold the value 'elt'.
 */
int link_specifier_set_un_ed25519_id(link_specifier_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t link_specifier_get_un_unrecognized(link_specifier_t *inp, size_t xap);
/** As link_specifier_get_un_unrecognized, but take and return a const
 * pointer
 */
uint8_t link_specifier_getconst_un_unrecognized(const link_specifier_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * un_unrecognized of the link_specifier_t in 'inp', so that it will
 * hold the value 'elt'.
 */
int link_specifier_set_un_unrecognized(link_specifier_t *inp, size_t xap, uint8_t elt);
/** Append a new element 'elt' to the dynamic array field
 * un_unrecognized of the link_specifier_t in 'inp'.
 */
 ...
 */
uint8_t ed25519_cert_get_certified_key(ed25519_cert_t *inp, size_t xap);
/** As ed25519_cert_get_certified_key, but take and return a const
 * pointer
 */
uint8_t ed25519_cert_getconst_certified_key(const ed25519_cert_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * certified_key of the ed25519_cert_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int ed25519_cert_set_certified_key(ed25519_cert_t *inp, size_t xap, uint8_t elt);
 ...
 */
struct ed25519_cert_extension_st * ed25519_cert_get_ext(ed25519_cert_t *inp, size_t xap);
/** As ed25519_cert_get_ext, but take and return a const pointer
 */
 const struct ed25519_cert_extension_st * ed25519_cert_getconst_ext(const ed25519_cert_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * ext of the ed25519_cert_t in 'inp', so that it will hold the value
 * 'elt'. Free the previous value, if any.
 */
int ed25519_cert_set_ext(ed25519_cert_t *inp, size_t xap, struct ed25519_cert_extension_st * elt);
/** As ed25519_cert_set_ext, but does not free the previous value.
 */
int ed25519_cert_set0_ext(ed25519_cert_t *inp, size_t xap, struct ed25519_cert_extension_st * elt);
 ...
 */
uint8_t ed25519_cert_get_signature(ed25519_cert_t *inp, size_t xap);
/** As ed25519_cert_get_signature, but take and return a const pointer
 */
uint8_t ed25519_cert_getconst_signature(const ed25519_cert_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * signature of the ed25519_cert_t in 'inp', so that it will hold the
 * value 'elt'.
 */
int ed25519_cert_set_signature(ed25519_cert_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the dynamic array field ls
 * of the extend2_cell_body_t in 'inp'.
 */
struct link_specifier_st * extend2_cell_body_get_ls(extend2_cell_body_t *inp, size_t xap);
/** As extend2_cell_body_get_ls, but take and return a const pointer
 */
 const struct link_specifier_st * extend2_cell_body_getconst_ls(const extend2_cell_body_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field ls
 * of the extend2_cell_body_t in 'inp', so that it will hold the value
 * 'elt'. Free the previous value, if any.
 */
int extend2_cell_body_set_ls(extend2_cell_body_t *inp, size_t xap, struct link_specifier_st * elt);
/** As extend2_cell_body_set_ls, but does not free the previous value.
 */
int extend2_cell_body_set0_ls(extend2_cell_body_t *inp, size_t xap, struct link_specifier_st * elt);
 ...
 */
struct link_specifier_st * link_specifier_list_get_spec(link_specifier_list_t *inp, size_t xap);
/** As link_specifier_list_get_spec, but take and return a const
 * pointer
 */
 const struct link_specifier_st * link_specifier_list_getconst_spec(const link_specifier_list_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * spec of the link_specifier_list_t in 'inp', so that it will hold
 * the value 'elt'. Free the previous value, if any.
 */
int link_specifier_list_set_spec(link_specifier_list_t *inp, size_t xap, struct link_specifier_st * elt);
/** As link_specifier_list_set_spec, but does not free the previous
 * value.
 */
int link_specifier_list_set0_spec(link_specifier_list_t *inp, size_t xap, struct link_specifier_st * elt);
