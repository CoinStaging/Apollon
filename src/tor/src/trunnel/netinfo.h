 ...
 */
uint8_t netinfo_addr_get_addr_ipv6(netinfo_addr_t *inp, size_t xap);
/** As netinfo_addr_get_addr_ipv6, but take and return a const pointer
 */
uint8_t netinfo_addr_getconst_addr_ipv6(const netinfo_addr_t *inp, size_t xap);
 ...
 * value 'elt'.
 */
int netinfo_addr_set_addr_ipv6(netinfo_addr_t *inp, size_t xap, uint8_t elt);
 ...
 */
struct netinfo_addr_st * netinfo_cell_get_my_addrs(netinfo_cell_t *inp, size_t xap);
/** As netinfo_cell_get_my_addrs, but take and return a const pointer
 */
 const struct netinfo_addr_st * netinfo_cell_getconst_my_addrs(const netinfo_cell_t *inp, size_t xap);
 ...
 */
int netinfo_cell_set_my_addrs(netinfo_cell_t *inp, size_t xap, struct netinfo_addr_st * elt);
/** As netinfo_cell_set_my_addrs, but does not free the previous
 * value.
 */
int netinfo_cell_set0_my_addrs(netinfo_cell_t *inp, size_t xap, struct netinfo_addr_st * elt);
