...
uint8_t
trn_cell_rendezvous1_get_rendezvous_cookie(trn_cell_rendezvous1_t *inp, size_t xap)
{
  trunnel_assert(xap < TRUNNEL_REND_COOKIE_LEN);
  return inp->rendezvous_cookie[xap];
}

uint8_t
trn_cell_rendezvous1_getconst_rendezvous_cookie(const trn_cell_rendezvous1_t *inp, size_t xap)
{
  return trn_cell_rendezvous1_get_rendezvous_cookie((trn_cell_rendezvous1_t*)inp, xap);
}
int
trn_cell_rendezvous1_set_rendezvous_cookie(trn_cell_rendezvous1_t *inp, size_t xap, uint8_t elt)
{
  trunnel_assert(xap < TRUNNEL_REND_COOKIE_LEN);
  inp->rendezvous_cookie[xap] = elt;
  return 0;
}
...
uint8_t
trn_cell_rendezvous1_get_handshake_info(trn_cell_rendezvous1_t *inp, size_t xap)
{
  return TRUNNEL_DYNARRAY_GET(&inp->handshake_info, xap);
}

uint8_t
trn_cell_rendezvous1_getconst_handshake_info(const trn_cell_rendezvous1_t *inp, size_t xap)
{
  return trn_cell_rendezvous1_get_handshake_info((trn_cell_rendezvous1_t*)inp, xap);
}
int
trn_cell_rendezvous1_set_handshake_info(trn_cell_rendezvous1_t *inp, size_t xap, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->handshake_info, xap, elt);
  return 0;
}
int
...
uint8_t
trn_cell_rendezvous2_get_handshake_info(trn_cell_rendezvous2_t *inp, size_t xap)
{
  trunnel_assert(xap < TRUNNEL_HANDSHAKE_INFO_LEN);
  return inp->handshake_info[xap];
}

uint8_t
trn_cell_rendezvous2_getconst_handshake_info(const trn_cell_rendezvous2_t *inp, size_t xap)
{
  return trn_cell_rendezvous2_get_handshake_info((trn_cell_rendezvous2_t*)inp, xap);
}
int
trn_cell_rendezvous2_set_handshake_info(trn_cell_rendezvous2_t *inp, size_t xap, uint8_t elt)
{
  trunnel_assert(xap < TRUNNEL_HANDSHAKE_INFO_LEN);
  inp->handshake_info[xap] = elt;
  return 0;
}
