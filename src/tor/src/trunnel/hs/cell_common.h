 ...
 */
uint8_t trn_cell_extension_fields_get_field(trn_cell_extension_fields_t *inp, size_t xap);
/** As trn_cell_extension_fields_get_field, but take and return a
 * const pointer
 */
uint8_t trn_cell_extension_fields_getconst_field(const trn_cell_extension_fields_t *inp, size_t xap);
 ...
 * hold the value 'elt'.
 */
int trn_cell_extension_fields_set_field(trn_cell_extension_fields_t *inp, size_t xap, uint8_t elt);
 ...
 */
struct trn_cell_extension_fields_st * trn_cell_extension_get_fields(trn_cell_extension_t *inp, size_t xap);
/** As trn_cell_extension_get_fields, but take and return a const
 * pointer
 */
 const struct trn_cell_extension_fields_st * trn_cell_extension_getconst_fields(const trn_cell_extension_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * fields of the trn_cell_extension_t in 'inp', so that it will hold
 * the value 'elt'. Free the previous value, if any.
 */
int trn_cell_extension_set_fields(trn_cell_extension_t *inp, size_t xap, struct trn_cell_extension_fields_st * elt);
/** As trn_cell_extension_set_fields, but does not free the previous
 * value.
 */
int trn_cell_extension_set0_fields(trn_cell_extension_t *inp, size_t xap, struct trn_cell_extension_fields_st * elt);
