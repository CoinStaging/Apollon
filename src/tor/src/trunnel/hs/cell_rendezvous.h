 ...
 */
uint8_t trn_cell_rendezvous1_get_rendezvous_cookie(trn_cell_rendezvous1_t *inp, size_t xap);
/** As trn_cell_rendezvous1_get_rendezvous_cookie, but take and return
 * a const pointer
 */
uint8_t trn_cell_rendezvous1_getconst_rendezvous_cookie(const trn_cell_rendezvous1_t *inp, size_t xap);
 ...
 */
int trn_cell_rendezvous1_set_rendezvous_cookie(trn_cell_rendezvous1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t trn_cell_rendezvous1_get_handshake_info(trn_cell_rendezvous1_t *inp, size_t xap);
/** As trn_cell_rendezvous1_get_handshake_info, but take and return a
 * const pointer
 */
uint8_t trn_cell_rendezvous1_getconst_handshake_info(const trn_cell_rendezvous1_t *inp, size_t xap);
 ...
 */
int trn_cell_rendezvous1_set_handshake_info(trn_cell_rendezvous1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t trn_cell_rendezvous2_get_handshake_info(trn_cell_rendezvous2_t *inp, size_t xap);
/** As trn_cell_rendezvous2_get_handshake_info, but take and return a
 * const pointer
 */
uint8_t trn_cell_rendezvous2_getconst_handshake_info(const trn_cell_rendezvous2_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * handshake_info of the trn_cell_rendezvous2_t in 'inp', so that it
 * will hold the value 'elt'.
 */
int trn_cell_rendezvous2_set_handshake_info(trn_cell_rendezvous2_t *inp, size_t xap, uint8_t elt);
