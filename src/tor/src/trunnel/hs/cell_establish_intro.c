...
uint8_t
trn_cell_establish_intro_get_auth_key(trn_cell_establish_intro_t *inp, size_t xap)
{
  return TRUNNEL_DYNARRAY_GET(&inp->auth_key, xap);
}

uint8_t
trn_cell_establish_intro_getconst_auth_key(const trn_cell_establish_intro_t *inp, size_t xap)
{
  return trn_cell_establish_intro_get_auth_key((trn_cell_establish_intro_t*)inp, xap);
}
int
trn_cell_establish_intro_set_auth_key(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt)
{
...
uint8_t
trn_cell_establish_intro_get_handshake_mac(trn_cell_establish_intro_t *inp, size_t xap)
{
  trunnel_assert(xap < TRUNNEL_SHA3_256_LEN);
  return inp->handshake_mac[xap];
}

uint8_t
trn_cell_establish_intro_getconst_handshake_mac(const trn_cell_establish_intro_t *inp, size_t xap)
{
  return trn_cell_establish_intro_get_handshake_mac((trn_cell_establish_intro_t*)inp, xap);
}
int
trn_cell_establish_intro_set_handshake_mac(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt)
{
  trunnel_assert(xap < TRUNNEL_SHA3_256_LEN);
  inp->handshake_mac[xap] = elt;
  return 0;
}
...
uint8_t
trn_cell_establish_intro_get_sig(trn_cell_establish_intro_t *inp, size_t xap)
{
  return TRUNNEL_DYNARRAY_GET(&inp->sig, xap);
}

uint8_t
trn_cell_establish_intro_getconst_sig(const trn_cell_establish_intro_t *inp, size_t xap)
{
  return trn_cell_establish_intro_get_sig((trn_cell_establish_intro_t*)inp, xap);
}
int
trn_cell_establish_intro_set_sig(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt)
{
