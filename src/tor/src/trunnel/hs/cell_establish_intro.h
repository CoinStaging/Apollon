 ...
 */
uint8_t trn_cell_establish_intro_get_auth_key(trn_cell_establish_intro_t *inp, size_t xap);
/** As trn_cell_establish_intro_get_auth_key, but take and return a
 * const pointer
 */
uint8_t trn_cell_establish_intro_getconst_auth_key(const trn_cell_establish_intro_t *inp, size_t xap);
 ...
 */
int trn_cell_establish_intro_set_auth_key(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t trn_cell_establish_intro_get_handshake_mac(trn_cell_establish_intro_t *inp, size_t xap);
/** As trn_cell_establish_intro_get_handshake_mac, but take and return
 * a const pointer
 */
uint8_t trn_cell_establish_intro_getconst_handshake_mac(const trn_cell_establish_intro_t *inp, size_t xap);
 ...
 */
int trn_cell_establish_intro_set_handshake_mac(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t trn_cell_establish_intro_get_sig(trn_cell_establish_intro_t *inp, size_t xap);
/** As trn_cell_establish_intro_get_sig, but take and return a const
 * pointer
 */
uint8_t trn_cell_establish_intro_getconst_sig(const trn_cell_establish_intro_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * sig of the trn_cell_establish_intro_t in 'inp', so that it will
 * hold the value 'elt'.
 */
int trn_cell_establish_intro_set_sig(trn_cell_establish_intro_t *inp, size_t xap, uint8_t elt);
