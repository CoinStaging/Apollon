 ...
 */
uint8_t pwbox_encoded_get_skey_header(pwbox_encoded_t *inp, size_t xap);
/** As pwbox_encoded_get_skey_header, but take and return a const
 * pointer
 */
uint8_t pwbox_encoded_getconst_skey_header(const pwbox_encoded_t *inp, size_t xap);
 ...
 * the value 'elt'.
 */
int pwbox_encoded_set_skey_header(pwbox_encoded_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field iv
 * of the pwbox_encoded_t in 'inp'.
 */
uint8_t pwbox_encoded_get_iv(pwbox_encoded_t *inp, size_t xap);
/** As pwbox_encoded_get_iv, but take and return a const pointer
 */
uint8_t pwbox_encoded_getconst_iv(const pwbox_encoded_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field iv
 * of the pwbox_encoded_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int pwbox_encoded_set_iv(pwbox_encoded_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t pwbox_encoded_get_data(pwbox_encoded_t *inp, size_t xap);
/** As pwbox_encoded_get_data, but take and return a const pointer
 */
uint8_t pwbox_encoded_getconst_data(const pwbox_encoded_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * data of the pwbox_encoded_t in 'inp', so that it will hold the
 * value 'elt'.
 */
int pwbox_encoded_set_data(pwbox_encoded_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field hmac
 * of the pwbox_encoded_t in 'inp'.
 */
uint8_t pwbox_encoded_get_hmac(pwbox_encoded_t *inp, size_t xap);
/** As pwbox_encoded_get_hmac, but take and return a const pointer
 */
uint8_t pwbox_encoded_getconst_hmac(const pwbox_encoded_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field hmac
 * of the pwbox_encoded_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int pwbox_encoded_set_hmac(pwbox_encoded_t *inp, size_t xap, uint8_t elt);
