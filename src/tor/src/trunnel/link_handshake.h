...
/** Return the element at position 'xap' of the fixed array field
 * challenge of the auth_challenge_cell_t in 'inp'.
 */
uint8_t auth_challenge_cell_get_challenge(auth_challenge_cell_t *inp, size_t xap);
/** As auth_challenge_cell_get_challenge, but take and return a const
 * pointer
 */
uint8_t auth_challenge_cell_getconst_challenge(const auth_challenge_cell_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * challenge of the auth_challenge_cell_t in 'inp', so that it will
 * hold the value 'elt'.
 */
int auth_challenge_cell_set_challenge(auth_challenge_cell_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the dynamic array field
 * methods of the auth_challenge_cell_t in 'inp'.
 */
uint16_t auth_challenge_cell_get_methods(auth_challenge_cell_t *inp, size_t xap);
/** As auth_challenge_cell_get_methods, but take and return a const
 * pointer
 */
uint16_t auth_challenge_cell_getconst_methods(const auth_challenge_cell_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * methods of the auth_challenge_cell_t in 'inp', so that it will hold
 * the value 'elt'.
 */
int auth_challenge_cell_set_methods(auth_challenge_cell_t *inp, size_t xap, uint16_t elt);
 ...
 */
uint8_t certs_cell_cert_get_body(certs_cell_cert_t *inp, size_t xap);
/** As certs_cell_cert_get_body, but take and return a const pointer
 */
uint8_t certs_cell_cert_getconst_body(const certs_cell_cert_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * body of the certs_cell_cert_t in 'inp', so that it will hold the
 * value 'elt'.
 */
int certs_cell_cert_set_body(certs_cell_cert_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t rsa_ed_crosscert_get_ed_key(rsa_ed_crosscert_t *inp, size_t xap);
/** As rsa_ed_crosscert_get_ed_key, but take and return a const
 * pointer
 */
uint8_t rsa_ed_crosscert_getconst_ed_key(const rsa_ed_crosscert_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * ed_key of the rsa_ed_crosscert_t in 'inp', so that it will hold the
 * value 'elt'.
 */
int rsa_ed_crosscert_set_ed_key(rsa_ed_crosscert_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t rsa_ed_crosscert_get_sig(rsa_ed_crosscert_t *inp, size_t xap);
/** As rsa_ed_crosscert_get_sig, but take and return a const pointer
 */
uint8_t rsa_ed_crosscert_getconst_sig(const rsa_ed_crosscert_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * sig of the rsa_ed_crosscert_t in 'inp', so that it will hold the
 * value 'elt'.
 */
int rsa_ed_crosscert_set_sig(rsa_ed_crosscert_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field type
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_type(auth1_t *inp, size_t xap);
/** As auth1_get_type, but take and return a const pointer
 */
uint8_t auth1_getconst_type(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field type
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_type(auth1_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field cid
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_cid(auth1_t *inp, size_t xap);
/** As auth1_get_cid, but take and return a const pointer
 */
uint8_t auth1_getconst_cid(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field cid
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_cid(auth1_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field sid
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_sid(auth1_t *inp, size_t xap);
/** As auth1_get_sid, but take and return a const pointer
 */
uint8_t auth1_getconst_sid(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field sid
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_sid(auth1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t auth1_get_u1_cid_ed(auth1_t *inp, size_t xap);
/** As auth1_get_u1_cid_ed, but take and return a const pointer
 */
uint8_t auth1_getconst_u1_cid_ed(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * u1_cid_ed of the auth1_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int auth1_set_u1_cid_ed(auth1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t auth1_get_u1_sid_ed(auth1_t *inp, size_t xap);
/** As auth1_get_u1_sid_ed, but take and return a const pointer
 */
uint8_t auth1_getconst_u1_sid_ed(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * u1_sid_ed of the auth1_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int auth1_set_u1_sid_ed(auth1_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field slog
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_slog(auth1_t *inp, size_t xap);
/** As auth1_get_slog, but take and return a const pointer
 */
uint8_t auth1_getconst_slog(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field slog
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_slog(auth1_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field clog
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_clog(auth1_t *inp, size_t xap);
/** As auth1_get_clog, but take and return a const pointer
 */
uint8_t auth1_getconst_clog(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field clog
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_clog(auth1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t auth1_get_scert(auth1_t *inp, size_t xap);
/** As auth1_get_scert, but take and return a const pointer
 */
uint8_t auth1_getconst_scert(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * scert of the auth1_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int auth1_set_scert(auth1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t auth1_get_tlssecrets(auth1_t *inp, size_t xap);
/** As auth1_get_tlssecrets, but take and return a const pointer
 */
uint8_t auth1_getconst_tlssecrets(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field
 * tlssecrets of the auth1_t in 'inp', so that it will hold the value
 * 'elt'.
 */
int auth1_set_tlssecrets(auth1_t *inp, size_t xap, uint8_t elt);
...
/** Return the element at position 'xap' of the fixed array field rand
 * of the auth1_t in 'inp'.
 */
uint8_t auth1_get_rand(auth1_t *inp, size_t xap);
/** As auth1_get_rand, but take and return a const pointer
 */
uint8_t auth1_getconst_rand(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the fixed array field rand
 * of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_rand(auth1_t *inp, size_t xap, uint8_t elt);
 ...
 */
uint8_t auth1_get_sig(auth1_t *inp, size_t xap);
/** As auth1_get_sig, but take and return a const pointer
 */
uint8_t auth1_getconst_sig(const auth1_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * sig of the auth1_t in 'inp', so that it will hold the value 'elt'.
 */
int auth1_set_sig(auth1_t *inp, size_t xap, uint8_t elt);
/** Append a new element 'elt' to the dynamic array field sig of the
 * auth1_t in 'inp'.
 */
 ...
 */
struct certs_cell_cert_st * certs_cell_get_certs(certs_cell_t *inp, size_t xap);
/** As certs_cell_get_certs, but take and return a const pointer
 */
 const struct certs_cell_cert_st * certs_cell_getconst_certs(const certs_cell_t *inp, size_t xap);
/** Change the element at position 'xap' of the dynamic array field
 * certs of the certs_cell_t in 'inp', so that it will hold the value
 * 'elt'. Free the previous value, if any.
 */
int certs_cell_set_certs(certs_cell_t *inp, size_t xap, struct certs_cell_cert_st * elt);
/** As certs_cell_set_certs, but does not free the previous value.
 */
int certs_cell_set0_certs(certs_cell_t *inp, size_t xap, struct certs_cell_cert_st * elt);
