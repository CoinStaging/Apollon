...
uint8_t
pwbox_encoded_get_skey_header(pwbox_encoded_t *inp, size_t xap)
{
  return TRUNNEL_DYNARRAY_GET(&inp->skey_header, xap);
}

uint8_t
pwbox_encoded_getconst_skey_header(const pwbox_encoded_t *inp, size_t xap)
{
  return pwbox_encoded_get_skey_header((pwbox_encoded_t*)inp, xap);
}
int
pwbox_encoded_set_skey_header(pwbox_encoded_t *inp, size_t xap, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->skey_header, xap, elt);
  return 0;
}
int
...
uint8_t
pwbox_encoded_get_iv(pwbox_encoded_t *inp, size_t xap)
{
...
uint8_t
pwbox_encoded_getconst_iv(const pwbox_encoded_t *inp, size_t xap)
{
  return pwbox_encoded_get_iv((pwbox_encoded_t*)inp, xap);
}
int
pwbox_encoded_set_iv(pwbox_encoded_t *inp, size_t xap, uint8_t elt)
{
  trunnel_assert(xap < 16);
  inp->iv[xap] = elt;
  return 0;
...
uint8_t
pwbox_encoded_get_data(pwbox_encoded_t *inp, size_t xap)
{
  return TRUNNEL_DYNARRAY_GET(&inp->data, xap);
}

uint8_t
pwbox_encoded_getconst_data(const pwbox_encoded_t *inp, size_t xap)
{
  return pwbox_encoded_get_data((pwbox_encoded_t*)inp, xap);
}
int
pwbox_encoded_set_data(pwbox_encoded_t *inp, size_t xap, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->data, xap, elt);
  return 0;
}
int
...
uint8_t
pwbox_encoded_get_hmac(pwbox_encoded_t *inp, size_t xap)
{
...
uint8_t
pwbox_encoded_getconst_hmac(const pwbox_encoded_t *inp, size_t xap)
{
  return pwbox_encoded_get_hmac((pwbox_encoded_t*)inp, xap);
}
int
pwbox_encoded_set_hmac(pwbox_encoded_t *inp, size_t xap, uint8_t elt)
{
  trunnel_assert(xap < 32);
  inp->hmac[xap] = elt;
  return 0;
