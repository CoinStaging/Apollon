...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"indexaddress\"     (string, required) The Apollon address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"indexaddress\", (string) The Apollon address validated\n"
...
UniValue createsporkkeypair(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"indexaddr\" : \"indexaddr\", (string) The Apollon public address \n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"indexaddress\"  (string, required) The Apollon address to use for the signature.\n"
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
                "getaddressutxos\n"
                        ...
                        "    \"outputIndex\"  (number) The output apollon\n"
    ...
    for (std::vector<std::pair<CAddressUnspentKey, CAddressUnspentValue> >::const_iterator it=unspentOutputs.begin(); it!=unspentOutputs.end(); it++) {
        ...
        output.push_back(Pair("outputIndex", (int)it->first.apollon));
    ...
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
                "getaddressdeltas\n"
                        ...
                        "    \"txid\"  (string) The related txid\n"
                        "    \"apollon\"  (number) The related input or output apollon\n"
                        "    \"blockindex\"  (number) The related block apollon\n"
                        "    \"height\"  (number) The block height\n"
                        "    \"address\"  (string) The base58check encoded address\n"
                        "  }\n"
                        "]\n"
...
UniValue getspentinfo(const UniValue& params, bool fHelp)
{
    ...
    UniValue indexValue = find_value(params[0].get_obj(), "apollon");
    ...
    obj.push_back(Pair("apollon", (int)value.inputIndex));
