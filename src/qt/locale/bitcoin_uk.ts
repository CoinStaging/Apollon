...
<context>
    ...
    <message>
        ...
        <translation>Підтвердіть, що Ви є власником повідомлення підписавши його Вашою Apollon-адресою </translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Apollon addresses</source>
        <translation>Перевірте повідомлення для впевненості, що воно підписано вказаною Apollon-адресою</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Створити запит платежу (генерує QR-код та apollon: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Відкрити apollon: URI чи запит платежу</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активне з'єднання з мережею Apollon</numerusform><numerusform>%n активні з'єднання з мережею Apollon</numerusform><numerusform>%n активних з'єднань з мережею Apollon</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Підключення до мережі Apollon через SOCKS5 проксі.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Підключатися до мережі Apollon через окремий SOCKS5 проксі для прихованих сервісів Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Показана інформація вже може бути застарілою. Ваш гаманець буде автоматично синхронізовано з мережею Apollon після встановлення підключення, але цей процес ще не завершено.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу Apollon (наприклад %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необов'язкове повідомлення на додаток до запиту платежу, котре буде показане під час відкриття запиту. Примітка: Це повідомлення не буде відправлено з платежем через мережу Apollon.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Оплата тільки мінімальної комісії є прийнятною, допоки обсяг транзакцій є меншим простору в блоках. Але майте на увазі, що це може анулювати транзакцію, якщо попит на Apollon транзакції стане більшим, ніж мережа зможе обробити.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адреса Apollon для відправлення платежу</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Повідомлення, що було додане до apollon: URI та буде збережено разом з транзакцією для довідки. Примітка: Це повідомлення не буде відправлено в мережу Apollon.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Отримувач:</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адреса Apollon для підпису цього повідомлення</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Обрати ранiш використовувану адресу</translation>
    ...
    <message>
        ...
        <translation>Адреса Apollon, якою було підписано це повідомлення</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Операція відсікання: остання синхронізація вмісту гаманцю не обмежується діями над скороченими данними. Вам необхідно зробити переіндексацію -reapollon (заново завантажити веcь ланцюжок блоків в разі появи скороченого ланцюга)</translation>
    </message>
    <message>
        ...
        <translation>Зменшити вимоги до наявного простору на носії даних за допомогою скорочення ланцюжка (видалення старих блоків). Цей режим несумісний з параметрами -txapollon та -rescan. Увага: при поверненні до типового значення видалені частини ланцюжка буде повторно завантажено. (типово: 0 = вимкнути скорочення ланцюжка, &gt;%u = очікуваний розмір файлів блоків в МіБ)</translation>
    </message>
    <message>
        ...
        <translation>Неможливо провести повторне сканування зі скороченим ланцюжком. Вам необхідно використати -reapollon для завантаження повного ланцюжка блоків.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Використання скороченого ланцюжка блоків несумісне з параметром -txapollon.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вам необхідно перебудувати базу даних з використанням -reapollon для завантаження повного ланцюжка блоків.</translation>
    </message>
    <message>
