...
extern const char *APOLLONNODEPAYMENTVOTE;
extern const char *APOLLONNODEPAYMENTSYNC;
...
enum GetDataMsg
{
    ...
    MSG_SPORK,
    MSG_APOLLONNODE_PAYMENT_VOTE,
    MSG_APOLLONNODE_PAYMENT_BLOCK,
    MSG_APOLLONNODE_ANNOUNCE,
    MSG_APOLLONNODE_PING,
    MSG_APOLLONNODE_VERIFY,
    MSG_TXLOCK_REQUEST,
    MSG_TXLOCK_VOTE,
    MSG_DSTX,
    DSQUEUE,
