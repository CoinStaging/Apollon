...
BOOST_AUTO_TEST_CASE(remint_basic_test)
{
    ...
    // spend coin for 100 xap
    BOOST_CHECK_MESSAGE(pwalletMain->CreateZerocoinSpendModel(stringError, "", "100", false, true), stringError + " - 100 xap spend failed");
    CreateAndProcessBlock({}, scriptPubKey);
    ...
    // Try remint for 100 xap. Again should pass
