...
{
    string strSecret = bitcoin_address_to_apollon(string("5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuS2F15C"));
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    BOOST_CHECK(merkleBlock.txn.ExtractMatches(vMatched, vApollon) == block.hashMerkleRoot);
